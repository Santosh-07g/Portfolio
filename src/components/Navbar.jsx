  ...
  return (
    <nav className='fixed w-full z-50 bg-dark-100/90 backdrop-blur-sm py-4 px-8 shadow-lg'>
        <div className='container mx-auto flex justify-between items-center'>
            <div>
                <a href="a" className='text-3xl font-bold text-white'>
                    Santosh 
                    <span className='text-purple'>Gurkhe</span>
            ...
            <div className='hidden md:flex space-x-10'>
                ...
                <a href="#experince" className='relative text-white/80 transition duration-300 hover:text-purple group'>
        ...
        {/* Mobile Menu */}
        {
            showMenu && (
                ...
                <a onClick={()=>setShowMenu(!showMenu)}href="#experince" className='relative text-white/80 transition duration-300 hover:text-purple group'>
